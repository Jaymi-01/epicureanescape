      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-foreground">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-serif text-background mb-6 leading-tight">
              An Exclusive <span className="text-primary italic">Culinary</span> Journey
            </motion.h1>
            <motion.p variants={fadeInUp} className="text-xl md:text-2xl font-sans text-background/90 mb-10 max-w-2xl mx-auto">
